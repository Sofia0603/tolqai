    ...
    <section id="dashboard" className="bg-color-black border-none shadow-lg md:shadow-none">
      <div className="bg-[#f4f4f4] py-10  rounded-t-4xl md:py-20">
        ...
        <div className="container mx-auto flex flex-col items-center px-3 xl:px-0">
          <h2 className=" text-color-dop text-xl text-center mt-2 md:text-2xl md:mb-3 xl:text-[32px]">Dashboard</h2>
          <h3 className=" text-[32px] text-center text-color-primary leading-10 mb-4 md:text-[40px] md:leading-12 md:mb-5 xl:text-[70px] xl:leading-20">Your AI-Powered Service<br/>Intelligence Platform</h3>
          <p className="text-[15px] text-color-second text-center md:text-xl max-w-170 xl:text-2xl">Web and mobile SaaS dashboard that transforms every conversation into actionable intelligence and performance metrics</p>
        </div>
