...
export default function LinkBottom({title, subtitle, linkName, href,target}:LinkBottomProps) {
    return (
        <div className="flex flex-col items-center text-center md:w-[300px]">
            ...
            <a href={href} target={target} className="flex flex-row gap-3 justify-center items-center button-gradient font-onest text-sm xl:text-lg">{linkName}</a>
        </div>
    )
}